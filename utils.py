...
def gradient_clipping(flow, gradnorm_queue, max_absolute_norm=5.0):
    # Allow gradient norm to be 150% + 2 * stdev of the recent history.
    adaptive_max = 1.5 * gradnorm_queue.mean() + 2 * gradnorm_queue.std()

    # Use the minimum of adaptive threshold and hard maximum to prevent explosion
    max_grad_norm = min(adaptive_max, max_absolute_norm)
